## Описание:<br/>
Данный README-файл написан для проекта 6ой практической работы "СОЗДАНИЕ АВТОМАТИЗИРОВАННЫХ UNIT-ТЕСТОВ Часть 1" по дисциплине "Поддержка и тестирование программных модулей".<br/>
...
#### Нормальная работа приложения:<br/>
![alt text](Images/normal_app_work.PNG) 
